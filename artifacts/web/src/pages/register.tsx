      ...
      <div className="w-full max-w-4xl flex bg-card rounded-3xl shadow-2xl overflow-hidden animate-slide-up relative z-10 border border-border/50">
        ...
        <div className="hidden md:block w-1/2 relative bg-primary/5">
          <img 
            ...
            className="absolute inset-0 w-full h-full object-cover mix-blend-multiply opacity-90 scale-x-[-1]"
          />
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-10 text-center md:text-left">
            ...
            <h1 className="text-4xl font-display font-extrabold text-foreground mb-2">Crie sua conta</h1>
            <p className="text-muted-foreground text-lg">Organize sua rotina escolar em minutos.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full mt-6 flex items-center justify-center gap-2 bg-primary text-primary-foreground py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary/25 hover:-translate-y-1 hover:shadow-xl transition-all disabled:opacity-70 disabled:hover:translate-y-0"
            >
              {isLoading ? <Loader2 className="w-6 h-6 animate-spin" /> : "Criar Conta"}
